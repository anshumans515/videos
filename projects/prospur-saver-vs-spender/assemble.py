...
CSS = f"""
  ...
  /* On a plate, not bare. The seam watermark rides over whatever footage is
     below the join, and against the bright office scenes the green accent
     letter dropped out completely — the mark read as "P OSPUR". A garbled
     brand name is worse than no watermark at all. */
  .seam-mark-inner {{ position: absolute; right: 30px; top: {SEAM_Y + 22}px;
